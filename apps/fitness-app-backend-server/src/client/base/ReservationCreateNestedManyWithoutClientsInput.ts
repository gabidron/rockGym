...
@InputType()
class ReservationCreateNestedManyWithoutClientsInput {
...
export { ReservationCreateNestedManyWithoutClientsInput as ReservationCreateNestedManyWithoutClientsInput };

...
@InputType()
class ReservationCreateNestedManyWithoutSchedulesInput {
...
export { ReservationCreateNestedManyWithoutSchedulesInput as ReservationCreateNestedManyWithoutSchedulesInput };
